                                ...
                                <form action="MainController" method="POST">
                                    <tr>
                                        ...
                                        <td  data-title="Xóa: " >
                                            <div>
                                                <c:if test="${contract.status eq '1'}">
                                                    <button type="submit" name="action" class="btn btn-outline-warning" value="DeleteContract">Xóa</button>             
                                                </c:if>
                                                <c:if test="${contract.status eq '0'}">
                                                    <button type="button" name="action" class="btn btn-outline-warning disabled" value="DeleteContract">Xóa</button>      
                                                </c:if> 
                                            </div>
                                        </td>
