...
<div class="container-fluid sticky-top" style="padding: 0px !important;">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark" style="border-radius: 5px">
        <a class="navbar-brand" href="#">BF Apartment</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample04">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item" onclick="addClassFunc()" >
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Yêu cầu</a>
