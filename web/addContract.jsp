                        ...
                        <div class="contractElement">
                            ...
                            <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="contractId" value="" required="">
                                ...
                                <div class="col-md-9 mb-3">
                                    ...
                                    <%
                                        try {
                                            String sql = "SELECT apartmentId, size FROM Apartments";
                                            Connection conn = utils.Utils.getConnection();
                                            PreparedStatement ptm = conn.prepareStatement(sql);
                                            ResultSet rs = ptm.executeQuery();
                                            while (rs.next()) {
                                    %>
                                    <option value=" <%=rs.getString("apartmentId")%>"><%=rs.getString("apartmentId")%>-<%=rs.getString("size")%></option>
                                    <%
                                            }
                                        } catch (Exception e) {
                                        }
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="service custom-select" name="ownerId">
                                        <%
                                            try {
                                                String sql = "SELECT ownerId, fullName FROM Owners";
                                                Connection conn = utils.Utils.getConnection();
                                                PreparedStatement ptm = conn.prepareStatement(sql);
                                                ResultSet rs = ptm.executeQuery();
                                                while (rs.next()) {
